...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Скидки, промокоды, акции', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Скидки, промокоды, акции', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://icoinus.online', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'скидки, промокоды, акции, кэшбэк', // 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,vkshare,okshare,mailru,viber,whatsapp,twitter,telegram,facebook,messenger,linkedin', // 分享的服務，按顺序显示,逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Все скидки', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
